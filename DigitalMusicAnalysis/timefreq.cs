...
namespace DigitalMusicAnalysis
{
    public class timefreq
    {
        ...
        public static int numberOfFFTCalls = 0;
        ...
        float[][] stft(Complex[] x, int wSamp)
        {
            ...
            Debug.WriteLine("the length of stft is: " + Math.Floor((double)N / (double)wSamp));
            ...
            Debug.WriteLine("The total number of FFT recursive calls is: " + numberOfFFTCalls);
